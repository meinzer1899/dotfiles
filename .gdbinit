...
# 4 bits are for condition codes (16 in total) (bits 31:28 in ARM contain the
# condition or 1111 if instruction is unconditional)
...
# bx Rn  => ARM bits 27-20: 0 0 0 1 0 0 1 0 , bits 7-4: 0 0 0 1 ; Thumb bits: 15-7:
# 0 1 0 0 0 1 1 1 0

# blx Rn => ARM bits 27-20: 0 0 0 1 0 0 1 0 , bits 7-4: 0 0 1 1 ; Thumb bits:
# 15-7: 0 1 0 0 0 1 1 1 1

# bl # => ARM bits 27-24: 1 0 1 1 ; Thumb bits: 15-11: 1 1 1 1 0

# blx # => ARM bits 31-25: 1 1 1 1 1 0 1 ; Thumb bits: 15-11:
# 1 1 1 1 0
...
# if it's a 0xE8 opcode, the total
# instruction size will be 5 bytes

# so we can simply calculate
# the next address and use
